...
{
	{
			...
			0x03,
			{0x00,0x04,0x07},
			{GPIO_DRIVER_MODE_INPUT,GPIO_DRIVER_MODE_INPUT,GPIO_DRIVER_MODE_GP_OUT},
			{DEFAULT,DEFAULT,GPIO_DRIVER_OUT_TYPE_PP},
			{GPIO_DRIVER_SPEED_HIGH,GPIO_DRIVER_SPEED_HIGH,GPIO_DRIVER_SPEED_HIGH},
			{GPIO_DRIVER_PUPD_NO_PUPD,GPIO_DRIVER_PUPD_PD,GPIO_DRIVER_PUPD_NO_PUPD},
